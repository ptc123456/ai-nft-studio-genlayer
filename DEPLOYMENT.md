...
| Prove the advertised transfer write | Transfer existed in code and tests but lacked live evidence | `0x75b2f544...c0361b` returned `true`; the round vote array contains five `AGREE` entries and owner readback changed to `0x7662...fDF5` |
